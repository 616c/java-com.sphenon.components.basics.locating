...
public class LocatorScope extends Locator {
    static protected Configuration config;
    static { config = Configuration.create(RootContext.getInitialisationContext(), "com.sphenon.basics.locating.locators.LocatorScope"); };

    public LocatorScope (CallContext context, String text_locator_value, Locator sub_locator, String locator_class_parameter_string) {
    ...
    protected Object retrieveLocalTarget(CallContext context) throws InvalidLocator {
        ...
        Object value = lc.getObject(context, name);

        if (value == null) {
            InvalidLocator.createAndThrow(context, "While resolving scope locator '%(locator)', no object named '%(name)' was found within scope", "locator", this.getTextLocatorValue(context), "name", name);

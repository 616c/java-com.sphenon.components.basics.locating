...
public class LocatingStringPool extends StringPoolClass {
    static protected LocatingStringPool singleton = null;

    static public LocatingStringPool getSingleton (CallContext cc) {
        if (singleton == null) {
            singleton = new LocatingStringPool(cc);
        }
        return singleton;
    }
    ...
    protected LocatingStringPool (CallContext cc) {
        super(cc);
        /*************************************************/
